...
#include "imguiext/ImGuiHelpers.h"
...
int main(int argc, char** argv) {
    ...
    menu.callback_draw_viewer_menu = [&]() {
        ...
        if (ImGui::CollapsingHeader("New Group", ImGuiTreeNodeFlags_DefaultOpen)) {
            ...
            ImGui::Combo("Direction", reinterpret_cast<int *>(&dir), "Up\0Down\0Left\0Right\0\0");
    ...
    viewer.data().add_label(viewer.data().V.row(0) + viewer.data().V_normals.row(0).normalized() * 0.005,
                            "Hello World!");
    viewer.launch();
}
